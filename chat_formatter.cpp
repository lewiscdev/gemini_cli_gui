    ...
    for (const QString& line : lines) {
        ...
        if (trimmed.startsWith("```")) {
            if (!inCodeBlock) {
                ...
                rawCodeBuffer.clear(); styledHtmlBuffer.clear();
            } else {
                inCodeBlock = false;
            ...
            if (inCodeBlock) {
                ...
                // Updated inline code span to use the new contrasting background and border radius
